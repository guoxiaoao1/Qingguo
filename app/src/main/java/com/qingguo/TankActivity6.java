...
public class TankActivity6 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tank6);
    ...
    public void onClickReturnTank(View view) throws IOException {
        ...
        intent.setClass(TankActivity6.this, SelectTankActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getStorageTanks","22");
