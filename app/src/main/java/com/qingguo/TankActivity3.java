...
public class TankActivity3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tank3);
    ...
    public void onClickReturnTank(View view) throws IOException {
        ...
        intent.setClass(TankActivity3.this, SelectTankActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getEmulsifierTank","1");
