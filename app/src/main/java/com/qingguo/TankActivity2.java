...
public class TankActivity2 extends Activity {
    ...
    public void onClickReturnTank(View view) throws IOException {
        ...
        intent.setClass(TankActivity2.this, SelectTankActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getMachineOilTank","");
