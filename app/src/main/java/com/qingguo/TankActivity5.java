...
public class TankActivity5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tank5);
    ...
    public void onClickReturnTank(View view) throws IOException {
        ...
        intent.setClass(TankActivity5.this, SelectTankActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getThePreparationOfTank","1");
