...
public class WaterActivity4 extends Activity {
    ...
    public void onClickReturnWater(View view) throws IOException {
        ...
        intent.setClass(WaterActivity4.this, SelectWaterActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getDissolvingTank","1");
