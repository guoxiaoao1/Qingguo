...
public class WaterActivity8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water8);
    ...
    public void onClickReturnWater(View view) throws IOException {
        ...
        intent.setClass(WaterActivity8.this, SelectWaterActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getStorageTanks","15");
