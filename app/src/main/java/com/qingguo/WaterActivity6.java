...
public class WaterActivity6 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water6);
    ...
    public void onClickReturnWater(View view) throws IOException {
        ...
        intent.setClass(WaterActivity6.this, SelectWaterActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getDissolvingTank","3");
