...
public class TankActivity4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tank4);
    ...
    public void onClickReturnTank(View view) throws IOException {
        ...
        intent.setClass(TankActivity4.this, SelectTankActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getEmulsifierTank","2");
