...
public class WaterActivity2 extends Activity {
    ...
    public void onClickReturnWater(View view) throws IOException {
        ...
        intent.setClass(WaterActivity2.this, SelectWaterActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getSteamTank","1");
