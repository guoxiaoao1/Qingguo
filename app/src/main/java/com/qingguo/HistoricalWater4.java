...
public class HistoricalWater4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.historical_water4);
...
//        showBarChart(mBarChart, mBarData);
    ...
    public void onClickReturnHistoricalWater(View view) throws IOException {
        ...
        intent.setClass(HistoricalWater4.this, HistoricalWaterActivity.class);
        ...
        if(a<=0){
            ...
            builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {  //这个是设置确定按钮
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    Toast.makeText(HistoricalWater4.this, "返回", Toast.LENGTH_SHORT).show();
                ...
                new Thread() {
                    public void run() {
                        try {
                            while (mRun) {
                                Thread.sleep(900);
                                new HistoricalWater4.AnotherTask().execute("JSON");
    ...
    protected void showDatePickDlg1() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(HistoricalWater4.this, new DatePickerDialog.OnDateSetListener() {

            @Override
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                HistoricalWater4.this.mEditText1.setText(year + "-" + monthOfYear + "-" + dayOfMonth);
                startyear=year;
    ...
    protected void showDatePickDlg2() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(HistoricalWater4.this, new DatePickerDialog.OnDateSetListener() {
            ...
            @Override
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                HistoricalWater4.this.mEditText2.setText(year + "-" + monthOfYear + "-" + dayOfMonth);
                overyear=year;
...
//      xAxis.setPosition(XAxisPosition.BOTTOM);
    ...
    private BarData getBarData(int count, float range) {
        ...
        // y轴的数据集合
        BarDataSet barDataSet = new BarDataSet(yValues, "4#发药管");
