...
public class ExplosiveActivity extends Activity {
    ...
    public void onClickReturnExplosive(View view) throws IOException {
        Intent intent = new Intent();
        intent.setClass(ExplosiveActivity.this, SelectExplosiveActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        ...
        String jsonReader=Tools.getmethods(app.getServerAddress(),"getExplosiveCar","");
       ...
       // int str = Tools.getnumber(app.getServerAddress());
        ...
        for (LineChart linechart : mChart) {
            ...
            if(linechart==linechart1) {
                ...
                // 增加高温
                LineDataSet highLineDataSet = data.getDataSetByIndex(HIGH);
                float fh = Float.parseFloat (residualDrug);
                Entry entryh = new Entry(fh, highLineDataSet.getEntryCount());
                data.addEntry(entryh, HIGH);
            ...
            Servera3.setText(residualDrug+"t");
