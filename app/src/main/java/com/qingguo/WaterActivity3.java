...
public class WaterActivity3 extends Activity {
    ...
    public void onClickReturnWater(View view) throws IOException {
        ...
        intent.setClass(WaterActivity3.this, SelectWaterActivity.class);
    ...
    private void addEntry(List<LineChart> mChart) {
        try {
            ...
            String jsonReader=Tools.getmethods(app.getServerAddress(),"getSteamTank","2");
            JSONObject json=new JSONObject(jsonReader);

            String mpa = json.optString("mpa");
